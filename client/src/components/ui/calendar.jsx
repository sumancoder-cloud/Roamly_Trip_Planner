    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <FiChevronLeftIcon className={cn("size-4", className)} {...props} />
            );
          }
          ...
          return (
            <FiChevronDownIcon className={cn("size-4", className)} {...props} />
          );
        },
        DayButton: FiCalendarDayButton,
...
export { FiCalendar, FiCalendarDayButton };
